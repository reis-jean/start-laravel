...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\LogAcessoMiddleware::class //adicionando o middlewae em todas as routes
        ],
    ...
    protected $middlewareAliases = [
        ...
        // Ao adicionar o Apelido é possivel chamar apenas o apelido nas routes, controllers e models: 
        //no arquivo web.php:
        // Route::get('/', 'App\Http\Controllers\PrincipalController@principal')->name('site.index')->middleware('log.acesso);
        //No controller sobre-nos
